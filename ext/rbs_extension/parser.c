...
static rbs_types_function_param_t *parse_function_param(parserstate *state) {
  ...
  if (state->next_token.type == pCOMMA || state->next_token.type == pRPAREN) {
    ...
    return rbs_types_function_param_new(&state->allocator, type, Qnil, location);
  } else {
    ...
    return rbs_types_function_param_new(&state->allocator, type, name, location);
  }
}
...
static rbs_types_proc_t *parse_proc_type(parserstate *state) {
  ...
  return rbs_types_proc_new(&state->allocator, function, block, loc->cached_ruby_value, proc_self);
}
...
static rbs_node_t *parse_instance_type(parserstate *state, bool parse_alias) {
    ...
    if (kind == CLASS_NAME) {
      return (rbs_node_t *) rbs_types_classinstance_new(&state->allocator, typename, types, location);
    } else if (kind == INTERFACE_NAME) {
      return (rbs_node_t *) rbs_types_interface_new(&state->allocator, typename, types, location);
    } else if (kind == ALIAS_NAME) {
      return (rbs_node_t *) rbs_types_alias_new(&state->allocator, typename, types, location);
    } else {
      return NULL;
    }
}
...
static rbs_types_classsingleton_t *parse_singleton_type(parserstate *state) {
  ...
  return rbs_types_classsingleton_new(&state->allocator, typename, location);
}
...
static rbs_node_t *parse_simple(parserstate *state) {
  ...
  case kBOOL: {
    ...
    return (rbs_node_t *) rbs_types_bases_bool_new(&state->allocator, loc->cached_ruby_value);
  }
  case kBOT: {
    rbs_location_t *loc = rbs_location_current_token(state);
    return (rbs_node_t *) rbs_types_bases_bottom_new(&state->allocator, loc->cached_ruby_value);
  }
  case kCLASS: {
    rbs_location_t *loc = rbs_location_current_token(state);
    return (rbs_node_t *) rbs_types_bases_class_new(&state->allocator, loc->cached_ruby_value);
  }
  case kINSTANCE: {
    rbs_location_t *loc = rbs_location_current_token(state);
    return (rbs_node_t *) rbs_types_bases_instance_new(&state->allocator, loc->cached_ruby_value);
  }
  case kNIL: {
    rbs_location_t *loc = rbs_location_current_token(state);
    return (rbs_node_t *) rbs_types_bases_nil_new(&state->allocator, loc->cached_ruby_value);
  }
  case kSELF: {
    rbs_location_t *loc = rbs_location_current_token(state);
    return (rbs_node_t *) rbs_types_bases_self_new(&state->allocator, loc->cached_ruby_value);
  }
  case kTOP: {
    rbs_location_t *loc = rbs_location_current_token(state);
    return (rbs_node_t *) rbs_types_bases_top_new(&state->allocator, loc->cached_ruby_value);
  }
  case kVOID: {
    rbs_location_t *loc = rbs_location_current_token(state);
    return (rbs_node_t *) rbs_types_bases_void_new(&state->allocator, loc->cached_ruby_value);
  }
  case kUNTYPED: {
    rbs_location_t *loc = rbs_location_current_token(state);
    return (rbs_node_t *) rbs_types_bases_any_new(&state->allocator, Qfalse, loc->cached_ruby_value);
  }
  case k__TODO__: {
    rbs_location_t *loc = rbs_location_current_token(state);
    return (rbs_node_t *) rbs_types_bases_any_new(&state->allocator, Qtrue, loc->cached_ruby_value);
  }
  case tINTEGER: {
    rbs_location_t *loc = rbs_location_current_token(state);
    ...
    return (rbs_node_t *) rbs_types_literal_new(&state->allocator, literal, loc->cached_ruby_value);
  }
  case kTRUE: {
    rbs_location_t *loc = rbs_location_current_token(state);
    return (rbs_node_t *) rbs_types_literal_new(&state->allocator, Qtrue, loc->cached_ruby_value);
  }
  case kFALSE: {
    rbs_location_t *loc = rbs_location_current_token(state);
    return (rbs_node_t *) rbs_types_literal_new(&state->allocator, Qfalse, loc->cached_ruby_value);
  }
  case tSQSTRING:
  case tDQSTRING: {
    rbs_location_t *loc = rbs_location_current_token(state);
  ...
  case tUIDENT: {
    ...
    if (parser_typevar_member(state, name)) {
      ...
      rbs_location_t *loc = rbs_location_current_token(state);
      return (rbs_node_t *) rbs_types_variable_new(&state->allocator, ID2SYM(name), loc->cached_ruby_value);
    }
  ...
  case pAREF_OPR: {
    rbs_location_t *loc = rbs_location_current_token(state);
    rbs_node_list_t *types = rbs_node_list_new();
    return (rbs_node_t *) rbs_types_tuple_new(&state->allocator, types, loc->cached_ruby_value);
  }
  case pLBRACE: {
    position start = state->current_token.range.start;
    ...
    position end = state->current_token.range.end;
    rbs_location_t *loc = rbs_location_pp(state->buffer, &start, &end);
    return (rbs_node_t *) rbs_types_record_new(&state->allocator, fields, loc->cached_ruby_value);
  }
  case pHAT: {
...
rbs_methodtype_t *parse_method_type(parserstate *state) {
  ...
  return rbs_methodtype_new(&state->allocator, type_params, function, block, location);
}
...
static rbs_ast_declarations_constant_t *parse_const_decl(parserstate *state) {
  ...
  return rbs_ast_declarations_constant_new(&state->allocator, typename, type, location, comment);
}
...
static rbs_ast_declarations_typealias_t *parse_type_decl(parserstate *state, position comment_pos, rbs_node_list_t *annotations) {
  ...
  return rbs_ast_declarations_typealias_new(&state->allocator, typename, type_params, type, annotations, location, comment);
}
...
static rbs_ast_members_methoddefinition_t *parse_member_def(parserstate *state, bool instance_only, bool accept_overload, position comment_pos, rbs_node_list_t *annotations) {
  ...
  rbs_location_t *location = rbs_location_new(state->buffer, member_range);
  rbs_loc *loc = rbs_check_location(location->cached_ruby_value);
  rbs_loc_alloc_children(loc, 5);
  rbs_loc_add_required_child(loc, INTERN("keyword"), keyword_range);
  rbs_loc_add_required_child(loc, INTERN("name"), name_range);
...
static rbs_node_t *parse_mixin_member(parserstate *state, bool from_interface, position comment_pos, rbs_node_list_t *annotations) {
  ...
  {
  case kINCLUDE:
    return (rbs_node_t *) rbs_ast_members_include_new(&state->allocator, name, args, annotations, location, comment);
  case kEXTEND:
    return (rbs_node_t *) rbs_ast_members_extend_new(&state->allocator, name, args, annotations, location, comment);
  case kPREPEND:
    return (rbs_node_t *) rbs_ast_members_prepend_new(&state->allocator, name, args, annotations, location, comment);
  default:
    rbs_abort();
  }
}
...
static rbs_ast_members_alias_t *parse_alias_member(parserstate *state, bool instance_only, position comment_pos, rbs_node_list_t *annotations) {
  ...
  return rbs_ast_members_alias_new(&state->allocator, new_name, old_name, kind, annotations, location, comment);
}
...
static rbs_node_t *parse_variable_member(parserstate *state, position comment_pos, rbs_node_list_t *annotations) {
  ...
  case tAIDENT: {
    ...
    return (rbs_node_t *)rbs_ast_members_instancevariable_new(&state->allocator, name, type, location, comment);
  }
  case tA2IDENT: {
    range name_range = state->current_token.range;
    rbs_ast_symbol_t *name = rbs_ast_symbol_new(&state->allocator, ID2SYM(INTERN_TOKEN(state, state->current_token)));
    ...
    return (rbs_node_t *) rbs_ast_members_classvariable_new(&state->allocator, name, type, location, comment);
  }
  ...
  case kSELF: {
    ...
    return (rbs_node_t *)rbs_ast_members_classinstancevariable_new(&state->allocator, name, type, location, comment);
  }
  default:
    rbs_abort();
  }
...
static rbs_node_t *parse_attribute_member(parserstate *state, position comment_pos, rbs_node_list_t *annotations) {
  ...
  {
  case kATTRREADER:
    return (rbs_node_t *) rbs_ast_members_attrreader_new(&state->allocator, attr_name, type, ivar_name, kind, annotations, location, comment, visibility_value);
  case kATTRWRITER:
    return (rbs_node_t *) rbs_ast_members_attrwriter_new(&state->allocator, attr_name, type, ivar_name, kind, annotations, location, comment, visibility_value);
  case kATTRACCESSOR:
    return (rbs_node_t *) rbs_ast_members_attraccessor_new(&state->allocator, attr_name, type, ivar_name, kind, annotations, location, comment, visibility_value);
  default:
    rbs_abort();
  }
}
...
static rbs_ast_declarations_interface_t *parse_interface_decl(parserstate *state, position comment_pos, rbs_node_list_t *annotations) {
  ...
  return rbs_ast_declarations_interface_new(&state->allocator, name, type_params, members, annotations, location, comment);
}
...
static void parse_module_self_types(parserstate *state, rbs_node_list_t *array) {
  while (true) {
    ...
    rbs_location_t *location = rbs_location_new(state->buffer, self_range);
    rbs_loc *loc = rbs_check_location(location->cached_ruby_value);
    rbs_loc_alloc_children(loc, 2);
    rbs_loc_add_required_child(loc, INTERN("name"), name_range);
    rbs_loc_add_optional_child(loc, INTERN("args"), args_range);

    rbs_ast_declarations_module_self_t *self_type = rbs_ast_declarations_module_self_new(&state->allocator, module_name, args, location);
...
static rbs_ast_declarations_module_t *parse_module_decl0(parserstate *state, range keyword_range, rbs_typename_t *module_name, range name_range, VALUE comment, rbs_node_list_t *annotations) {
  ...
  return rbs_ast_declarations_module_new(&state->allocator, module_name, type_params, self_types, members, annotations, location, comment);
}
...
static rbs_node_t *parse_module_decl(parserstate *state, position comment_pos, rbs_node_list_t *annotations) {
  ...
  if (state->next_token.type == pEQ) {
    ...
    return (rbs_node_t *) rbs_ast_declarations_modulealias_new(&state->allocator, module_name, old_name, location, comment);
  } else {
...
static rbs_ast_declarations_class_t *parse_class_decl0(parserstate *state, range keyword_range, rbs_typename_t *name, range name_range, VALUE comment, rbs_node_list_t *annotations) {
  ...
  return rbs_ast_declarations_class_new(&state->allocator, name, type_params, super, members, annotations, location, comment);
}
...
static rbs_node_t *parse_class_decl(parserstate *state, position comment_pos, rbs_node_list_t *annotations) {
  ...
  if (state->next_token.type == pEQ) {
    ...
    return (rbs_node_t *) rbs_ast_declarations_classalias_new(&state->allocator, class_name, old_name, location, comment);
  } else {
