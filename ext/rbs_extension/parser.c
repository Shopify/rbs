...
*/
static rbs_ast_declarations_typealias_t *parse_type_decl(parserstate *state, position comment_pos, VALUE annotations) {
  ...
  return rbs_ast_declarations_typealias_new(&state->allocator, value, ((rbs_node_t *)typename)->cached_ruby_value, type_params->cached_ruby_value, type->cached_ruby_value, annotations, location, comment);
}
...
static rbs_ast_members_methoddefinition_t *parse_member_def(parserstate *state, bool instance_only, bool accept_overload, position comment_pos, VALUE annotations) {
  ...
  return rbs_ast_members_methoddefinition_new(&state->allocator, value, name, k, overloads, annotations, location, comment, overloading, visibility);
}
...
static rbs_node_t *parse_mixin_member(parserstate *state, bool from_interface, position comment_pos, VALUE annotations) {
  ...
  case kINCLUDE: {
    ...
    return (rbs_node_t *)rbs_ast_members_include_new(&state->allocator, value, name, args, annotations, location, comment);
  }
  case kEXTEND: {
    VALUE value = rbs_ast_members_extend(name, args, annotations, location, comment);
    return (rbs_node_t *)rbs_ast_members_extend_new(&state->allocator, value, name, args, annotations, location, comment);
  }
  case kPREPEND: {
    VALUE value = rbs_ast_members_prepend(name, args, annotations, location, comment);
    return (rbs_node_t *)rbs_ast_members_prepend_new(&state->allocator, value, name, args, annotations, location, comment);
  }
  default:
    rbs_abort();
  }
...
static rbs_ast_members_alias_t *parse_alias_member(parserstate *state, bool instance_only, position comment_pos, VALUE annotations) {
  ...
  return rbs_ast_members_alias_new(&state->allocator, value, new_name, old_name, kind, annotations, location, comment);
}
...
static rbs_node_t *parse_attribute_member(parserstate *state, position comment_pos, VALUE annotations) {
  ...
  case kATTRREADER: {
    ...
    return (rbs_node_t *)rbs_ast_members_attrreader_new(&state->allocator, value, attr_name, type->cached_ruby_value, ivar_name, kind, annotations, location, comment, visibility);
  }
  case kATTRWRITER: {
    ...
    return (rbs_node_t *)rbs_ast_members_attrwriter_new(&state->allocator, value, attr_name, type->cached_ruby_value, ivar_name, kind, annotations, location, comment, visibility);
  }
  case kATTRACCESSOR: {
    ...
    return (rbs_node_t *)rbs_ast_members_attraccessor_new(&state->allocator, value, attr_name, type->cached_ruby_value, ivar_name, kind, annotations, location, comment, visibility);
  }
  default:
    rbs_abort();
  }
...
static rbs_ast_declarations_interface_t *parse_interface_decl(parserstate *state, position comment_pos, VALUE annotations) {
  ...
  return rbs_ast_declarations_interface_new(&state->allocator, value, ((rbs_node_t *)name)->cached_ruby_value, type_params->cached_ruby_value, members->cached_ruby_value, annotations, location, comment);
}
...
static rbs_ast_declarations_module_t *parse_module_decl0(parserstate *state, range keyword_range, VALUE module_name, range name_range, VALUE comment, VALUE annotations) {
  ...
  return rbs_ast_declarations_module_new(&state->allocator, value, module_name, type_params->cached_ruby_value, self_types, members->cached_ruby_value, annotations, location, comment);
}
...
static rbs_ast_declarations_class_t *parse_class_decl0(parserstate *state, range keyword_range, VALUE name, range name_range, VALUE comment, VALUE annotations) {
  ...
  return rbs_ast_declarations_class_new(&state->allocator, value, name, type_params->cached_ruby_value, super, members->cached_ruby_value, annotations, location, comment);
}
