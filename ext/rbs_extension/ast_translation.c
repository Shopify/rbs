...
VALUE rbs_struct_to_ruby_value(rbs_node_t *instance) {
    ...
    switch (instance->type) {
        ...
        case RBS_TYPES_PROC: {
            ...
            // [#<RBS::Template::Field name="type" c_type="VALUE">, #<RBS::Template::Field name="block" c_type="VALUE">, #<RBS::Template::Field name="location" c_type="rbs_location">, #<RBS::Template::Field name="self_type" c_type="VALUE">]
            VALUE h = rb_hash_new();
            rb_hash_aset(h, ID2SYM(rb_intern("type")), node->type);
            rb_hash_aset(h, ID2SYM(rb_intern("block")), node->block);
            rb_hash_aset(h, ID2SYM(rb_intern("location")), rbs_loc_to_ruby_location(node->location));
