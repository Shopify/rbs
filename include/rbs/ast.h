...
rbs_keyword_t *rbs_keyword_new(rbs_location_t *, rbs_constant_id_t);
...
rbs_ast_symbol_t *rbs_ast_symbol_new(rbs_location_t *, rbs_constant_pool_t *, rbs_constant_id_t);
