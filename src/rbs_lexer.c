...
yy1:
	rbs_skip(state);
#line 144 "src/rbs_lexer.re"
	{ return rbs_next_eof_token(state); }
#line 121 "src/rbs_lexer.c"
yy2:
	rbs_skip(state);
yy3:
#line 145 "src/rbs_lexer.re"
	{ return rbs_next_token(state, ErrorToken); }
#line 127 "src/rbs_lexer.c"
yy4:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych == '\t') goto yy4;
	if (yych == ' ') goto yy4;
yy5:
#line 143 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tTRIVIA); }
#line 136 "src/rbs_lexer.c"
yy6:
	rbs_skip(state);
	goto yy5;
yy7:
	...
	if (yych == '~') goto yy24;
yy8:
#line 48 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tOPERATOR); }
#line 148 "src/rbs_lexer.c"
yy9:
	yyaccept = 0;
	rbs_skip(state);
	backup = *state;
...
yy14:
	rbs_skip(state);
#line 33 "src/rbs_lexer.re"
	{ return rbs_next_token(state, pAMP); }
#line 227 "src/rbs_lexer.c"
yy15:
	yyaccept = 0;
	rbs_skip(state);
	backup = *state;
...
yy16:
	rbs_skip(state);
#line 24 "src/rbs_lexer.re"
	{ return rbs_next_token(state, pLPAREN); }
#line 239 "src/rbs_lexer.c"
yy17:
	rbs_skip(state);
#line 25 "src/rbs_lexer.re"
	{ return rbs_next_token(state, pRPAREN); }
#line 244 "src/rbs_lexer.c"
yy18:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych == '*') goto yy80;
#line 35 "src/rbs_lexer.re"
	{ return rbs_next_token(state, pSTAR); }
#line 251 "src/rbs_lexer.c"
yy19:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= '/') goto yy8;
...
yy20:
	rbs_skip(state);
#line 30 "src/rbs_lexer.re"
	{ return rbs_next_token(state, pCOMMA); }
#line 263 "src/rbs_lexer.c"
yy21:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= '=') {
...
yy22:
	...
	if (yych == '.') goto yy82;
yy23:
#line 37 "src/rbs_lexer.re"
	{ return rbs_next_token(state, pDOT); }
#line 285 "src/rbs_lexer.c"
yy24:
	rbs_skip(state);
	goto yy8;
yy25:
	...
	if (yych == '_') goto yy25;
yy26:
#line 51 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tINTEGER); }
#line 298 "src/rbs_lexer.c"
yy27:
	yyaccept = 3;
	rbs_skip(state);
	backup = *state;
...
yy28:
#line 44 "src/rbs_lexer.re"
	{ return rbs_next_token(state, pCOLON); }
#line 383 "src/rbs_lexer.c"
yy29:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= ';') goto yy30;
	...
	if (yych <= '=') goto yy99;
yy30:
#line 46 "src/rbs_lexer.re"
	{ return rbs_next_token(state, pLT); }
#line 393 "src/rbs_lexer.c"
yy31:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= '>') {
...
yy32:
#line 43 "src/rbs_lexer.re"
	{ return rbs_next_token(state, pEQ); }
#line 407 "src/rbs_lexer.c"
yy33:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= '<') goto yy8;
...
yy34:
	rbs_skip(state);
#line 34 "src/rbs_lexer.re"
	{ return rbs_next_token(state, pQUESTION); }
#line 418 "src/rbs_lexer.c"
yy35:
	yyaccept = 0;
	rbs_skip(state);
	backup = *state;
...
yy37:
#line 129 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tUIDENT); }
#line 456 "src/rbs_lexer.c"
yy38:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych == ']') goto yy107;
#line 26 "src/rbs_lexer.re"
	{ return rbs_next_token(state, pLBRACKET); }
#line 463 "src/rbs_lexer.c"
yy39:
	rbs_skip(state);
#line 27 "src/rbs_lexer.re"
	{ return rbs_next_token(state, pRBRACKET); }
#line 468 "src/rbs_lexer.c"
yy40:
	rbs_skip(state);
#line 32 "src/rbs_lexer.re"
	{ return rbs_next_token(state, pHAT); }
#line 473 "src/rbs_lexer.c"
yy41:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= '=') {
...
yy42:
#line 132 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tULLIDENT); }
#line 497 "src/rbs_lexer.c"
yy43:
	yyaccept = 4;
	rbs_skip(state);
	backup = *state;
...
yy44:
#line 39 "src/rbs_lexer.re"
	{  return rbs_next_token(state, tOPERATOR); }
#line 512 "src/rbs_lexer.c"
yy45:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= 'r') {
...
yy46:
#line 128 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tLIDENT); }
#line 527 "src/rbs_lexer.c"
yy47:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy63:
	rbs_skip(state);
#line 28 "src/rbs_lexer.re"
	{ return rbs_next_token(state, pLBRACE); }
#line 636 "src/rbs_lexer.c"
yy64:
	rbs_skip(state);
#line 31 "src/rbs_lexer.re"
	{ return rbs_next_token(state, pBAR); }
#line 641 "src/rbs_lexer.c"
yy65:
	rbs_skip(state);
#line 29 "src/rbs_lexer.re"
	{ return rbs_next_token(state, pRBRACE); }
#line 646 "src/rbs_lexer.c"
yy66:
	rbs_skip(state);
	yych = rbs_peek(state);
yy67:
...
yy69:
	rbs_skip(state);
#line 106 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tDQSTRING); }
#line 690 "src/rbs_lexer.c"
yy70:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy72:
#line 139 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tGIDENT); }
#line 729 "src/rbs_lexer.c"
yy73:
	rbs_skip(state);
	goto yy72;
yy74:
...
yy77:
	rbs_skip(state);
yy78:
#line 107 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tSQSTRING); }
#line 770 "src/rbs_lexer.c"
yy79:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= '\'') {
...
yy80:
	rbs_skip(state);
#line 36 "src/rbs_lexer.re"
	{ return rbs_next_token(state, pSTAR2); }
#line 786 "src/rbs_lexer.c"
yy81:
	rbs_skip(state);
#line 41 "src/rbs_lexer.re"
	{ return rbs_next_token(state, pARROW); }
#line 791 "src/rbs_lexer.c"
yy82:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych == '.') goto yy148;
...
yy83:
	...
	if (yych == '~') goto yy87;
yy84:
#line 126 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tSYMBOL); }
#line 805 "src/rbs_lexer.c"
yy85:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= '"') {
...
yy91:
	rbs_skip(state);
#line 45 "src/rbs_lexer.re"
	{ return rbs_next_token(state, pCOLON2); }
#line 891 "src/rbs_lexer.c"
yy92:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= ';') goto yy84;
...
yy97:
#line 122 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tSYMBOL); }
#line 947 "src/rbs_lexer.c"
yy98:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych == ']') goto yy158;
...
yy101:
	rbs_skip(state);
#line 42 "src/rbs_lexer.re"
	{ return rbs_next_token(state, pFATARROW); }
#line 967 "src/rbs_lexer.c"
yy102:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= '^') {
...
yy104:
#line 136 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tAIDENT); }
#line 998 "src/rbs_lexer.c"
yy105:
	rbs_skip(state);
#line 133 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tBANGIDENT); }
#line 1003 "src/rbs_lexer.c"
yy106:
	rbs_skip(state);
#line 134 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tEQIDENT); }
#line 1008 "src/rbs_lexer.c"
yy107:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych == '=') goto yy24;
#line 47 "src/rbs_lexer.re"
	{ return rbs_next_token(state, pAREF_OPR); }
#line 1015 "src/rbs_lexer.c"
yy108:
	rbs_skip(state);
	yych = rbs_peek(state);
yy109:
...
yy110:
#line 130 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tULLIDENT); }
#line 1039 "src/rbs_lexer.c"
yy111:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= '=') {
...
yy112:
#line 131 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tULIDENT); }
#line 1062 "src/rbs_lexer.c"
yy113:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy117:
#line 96 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kAS); }
#line 1101 "src/rbs_lexer.c"
yy118:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy126:
#line 77 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kIN); }
#line 1171 "src/rbs_lexer.c"
yy127:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy148:
	rbs_skip(state);
#line 38 "src/rbs_lexer.re"
	{ return rbs_next_token(state, pDOT3); }
#line 1307 "src/rbs_lexer.c"
yy149:
	rbs_skip(state);
#line 108 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tDQSYMBOL); }
#line 1312 "src/rbs_lexer.c"
yy150:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy152:
#line 125 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tSYMBOL); }
#line 1351 "src/rbs_lexer.c"
yy153:
	rbs_skip(state);
	goto yy152;
yy154:
	rbs_skip(state);
yy155:
#line 109 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tSQSYMBOL); }
#line 1360 "src/rbs_lexer.c"
yy156:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= '\'') {
...
yy161:
#line 123 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tSYMBOL); }
#line 1417 "src/rbs_lexer.c"
yy162:
	rbs_skip(state);
	goto yy97;
yy163:
...
yy164:
#line 137 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tA2IDENT); }
#line 1439 "src/rbs_lexer.c"
yy165:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy166:
	rbs_skip(state);
#line 40 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tQIDENT); }
#line 1449 "src/rbs_lexer.c"
yy167:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy171:
#line 71 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kBOT); }
#line 1487 "src/rbs_lexer.c"
yy172:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy174:
#line 73 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kDEF); }
#line 1515 "src/rbs_lexer.c"
yy175:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= '=') {
...
yy176:
#line 74 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kEND); }
#line 1538 "src/rbs_lexer.c"
yy177:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy184:
#line 82 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kNIL); }
#line 1591 "src/rbs_lexer.c"
yy185:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= '=') {
...
yy186:
#line 83 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kOUT); }
#line 1614 "src/rbs_lexer.c"
yy187:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy193:
#line 89 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kTOP); }
#line 1662 "src/rbs_lexer.c"
yy194:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy199:
#line 95 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kUSE); }
#line 1705 "src/rbs_lexer.c"
yy200:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy202:
	rbs_skip(state);
#line 54 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tANNOTATION); }
#line 1728 "src/rbs_lexer.c"
yy203:
	rbs_skip(state);
#line 57 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tANNOTATION); }
#line 1733 "src/rbs_lexer.c"
yy204:
	rbs_skip(state);
#line 55 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tANNOTATION); }
#line 1738 "src/rbs_lexer.c"
yy205:
	rbs_skip(state);
#line 53 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tANNOTATION); }
#line 1743 "src/rbs_lexer.c"
yy206:
	rbs_skip(state);
#line 56 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tANNOTATION); }
#line 1748 "src/rbs_lexer.c"
yy207:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= '@') {
...
yy211:
#line 124 "src/rbs_lexer.re"
	{ return rbs_next_token(state, tSYMBOL); }
#line 1806 "src/rbs_lexer.c"
yy212:
	rbs_skip(state);
	goto yy161;
yy213:
...
yy217:
#line 70 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kBOOL); }
#line 1847 "src/rbs_lexer.c"
yy218:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy229:
#line 87 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kSELF); }
#line 1920 "src/rbs_lexer.c"
yy230:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy232:
#line 90 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kTRUE); }
#line 1948 "src/rbs_lexer.c"
yy233:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= '=') {
...
yy234:
#line 91 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kTYPE); }
#line 1971 "src/rbs_lexer.c"
yy235:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy238:
#line 94 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kVOID); }
#line 2004 "src/rbs_lexer.c"
yy239:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= '@') {
...
yy244:
#line 66 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kALIAS); }
#line 2061 "src/rbs_lexer.c"
yy245:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= 'q') {
...
yy247:
#line 72 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kCLASS); }
#line 2095 "src/rbs_lexer.c"
yy248:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy250:
#line 76 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kFALSE); }
#line 2123 "src/rbs_lexer.c"
yy251:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy268:
#line 75 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kEXTEND); }
#line 2242 "src/rbs_lexer.c"
yy269:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy273:
#line 81 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kMODULE); }
#line 2280 "src/rbs_lexer.c"
yy274:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy277:
#line 86 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kPUBLIC); }
#line 2313 "src/rbs_lexer.c"
yy278:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy287:
#line 78 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kINCLUDE); }
#line 2384 "src/rbs_lexer.c"
yy288:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy291:
#line 84 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kPREPEND); }
#line 2417 "src/rbs_lexer.c"
yy292:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= '=') {
...
yy293:
#line 85 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kPRIVATE); }
#line 2440 "src/rbs_lexer.c"
yy294:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy297:
#line 93 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kUNTYPED); }
#line 2473 "src/rbs_lexer.c"
yy298:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= '=') {
...
yy299:
#line 97 "src/rbs_lexer.re"
	{ return rbs_next_token(state, k__TODO__); }
#line 2496 "src/rbs_lexer.c"
yy300:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy304:
#line 79 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kINSTANCE); }
#line 2534 "src/rbs_lexer.c"
yy305:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy312:
#line 80 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kINTERFACE); }
#line 2587 "src/rbs_lexer.c"
yy313:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= '=') {
...
yy314:
#line 88 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kSINGLETON); }
#line 2610 "src/rbs_lexer.c"
yy315:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= '=') {
...
yy316:
#line 92 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kUNCHECKED); }
#line 2633 "src/rbs_lexer.c"
yy317:
	rbs_skip(state);
	yych = rbs_peek(state);
...
yy322:
#line 68 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kATTRREADER); }
#line 2676 "src/rbs_lexer.c"
yy323:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych <= '=') {
...
yy324:
#line 69 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kATTRWRITER); }
#line 2699 "src/rbs_lexer.c"
yy325:
	rbs_skip(state);
	yych = rbs_peek(state);
	if (yych != 'r') goto yy53;
...
yy326:
#line 67 "src/rbs_lexer.re"
	{ return rbs_next_token(state, kATTRACCESSOR); }
#line 2725 "src/rbs_lexer.c"
}
#line 146 "src/rbs_lexer.re"
