...
rbs_ast_annotation_t *rbs_ast_annotation_new(VALUE string, VALUE location) {
    rbs_ast_annotation_t *node = malloc(sizeof(rbs_ast_annotation_t));

    *node = (rbs_ast_annotation_t) {
        .base = (rbs_node_t) {
    ...
    rb_gc_register_address(&node->string);
    rb_gc_register_address(&node->location);

    return node;
}

rbs_ast_comment_t *rbs_ast_comment_new(VALUE string, VALUE location) {
    rbs_ast_comment_t *node = malloc(sizeof(rbs_ast_comment_t));
...
rbs_ast_declarations_class_t *rbs_ast_declarations_class_new(VALUE name, VALUE type_params, VALUE super_class, VALUE members, VALUE annotations, VALUE location, VALUE comment) {
    rbs_ast_declarations_class_t *node = malloc(sizeof(rbs_ast_declarations_class_t));

    *node = (rbs_ast_declarations_class_t) {
        .base = (rbs_node_t) {
    ...
    // that will own them. The fields are unmarked in `rbs_struct_to_ruby_value` where we create the final Ruby object
    // and free the intermediate C struct.
    rb_gc_register_address(&node->name);
    rb_gc_register_address(&node->type_params);
    rb_gc_register_address(&node->super_class);
    rb_gc_register_address(&node->members);
    rb_gc_register_address(&node->annotations);
    rb_gc_register_address(&node->location);
    rb_gc_register_address(&node->comment);

    return node;
}

rbs_ast_declarations_class_super_t *rbs_ast_declarations_class_super_new(VALUE name, VALUE args, VALUE location) {
    rbs_ast_declarations_class_super_t *node = malloc(sizeof(rbs_ast_declarations_class_super_t));

    *node = (rbs_ast_declarations_class_super_t) {
        .base = (rbs_node_t) {
    ...
    // and free the intermediate C struct.
    rb_gc_register_address(&node->name);
    rb_gc_register_address(&node->args);
    rb_gc_register_address(&node->location);
...
rbs_ast_declarations_class_alias_t *rbs_ast_declarations_class_alias_new(VALUE new_name, VALUE old_name, VALUE location, VALUE comment) {
    rbs_ast_declarations_class_alias_t *node = malloc(sizeof(rbs_ast_declarations_class_alias_t));

    *node = (rbs_ast_declarations_class_alias_t) {
        .base = (rbs_node_t) {
    ...
    // that will own them. The fields are unmarked in `rbs_struct_to_ruby_value` where we create the final Ruby object
    // and free the intermediate C struct.
    rb_gc_register_address(&node->new_name);
    rb_gc_register_address(&node->old_name);
    rb_gc_register_address(&node->location);
    rb_gc_register_address(&node->comment);
...
rbs_ast_declarations_constant_t *rbs_ast_declarations_constant_new(VALUE name, VALUE type, VALUE location, VALUE comment) {
    rbs_ast_declarations_constant_t *node = malloc(sizeof(rbs_ast_declarations_constant_t));

    *node = (rbs_ast_declarations_constant_t) {
        .base = (rbs_node_t) {
    ...
    // and free the intermediate C struct.
    rb_gc_register_address(&node->name);
    rb_gc_register_address(&node->type);
    rb_gc_register_address(&node->location);
    rb_gc_register_address(&node->comment);
...
rbs_ast_declarations_global_t *rbs_ast_declarations_global_new(VALUE name, VALUE type, VALUE location, VALUE comment) {
    rbs_ast_declarations_global_t *node = malloc(sizeof(rbs_ast_declarations_global_t));

    *node = (rbs_ast_declarations_global_t) {
        .base = (rbs_node_t) {
...
rbs_ast_declarations_interface_t *rbs_ast_declarations_interface_new(VALUE name, VALUE type_params, VALUE members, VALUE annotations, VALUE location, VALUE comment) {
    rbs_ast_declarations_interface_t *node = malloc(sizeof(rbs_ast_declarations_interface_t));

    *node = (rbs_ast_declarations_interface_t) {
        .base = (rbs_node_t) {
...
rbs_ast_declarations_module_t *rbs_ast_declarations_module_new(VALUE name, VALUE type_params, VALUE self_types, VALUE members, VALUE annotations, VALUE location, VALUE comment) {
    rbs_ast_declarations_module_t *node = malloc(sizeof(rbs_ast_declarations_module_t));

    *node = (rbs_ast_declarations_module_t) {
        .base = (rbs_node_t) {
    ...
    rb_gc_register_address(&node->name);
    rb_gc_register_address(&node->type_params);
    rb_gc_register_address(&node->self_types);
    rb_gc_register_address(&node->members);
    rb_gc_register_address(&node->annotations);
    rb_gc_register_address(&node->location);
    rb_gc_register_address(&node->comment);
...
rbs_ast_declarations_module_self_t *rbs_ast_declarations_module_self_new(VALUE name, VALUE args, VALUE location) {
    rbs_ast_declarations_module_self_t *node = malloc(sizeof(rbs_ast_declarations_module_self_t));
...
rbs_ast_declarations_module_alias_t *rbs_ast_declarations_module_alias_new(VALUE new_name, VALUE old_name, VALUE location, VALUE comment) {
    rbs_ast_declarations_module_alias_t *node = malloc(sizeof(rbs_ast_declarations_module_alias_t));

    *node = (rbs_ast_declarations_module_alias_t) {
        .base = (rbs_node_t) {
...
rbs_ast_declarations_type_alias_t *rbs_ast_declarations_type_alias_new(VALUE name, VALUE type_params, VALUE type, VALUE annotations, VALUE location, VALUE comment) {
    rbs_ast_declarations_type_alias_t *node = malloc(sizeof(rbs_ast_declarations_type_alias_t));

    *node = (rbs_ast_declarations_type_alias_t) {
        .base = (rbs_node_t) {
...
rbs_ast_directives_use_t *rbs_ast_directives_use_new(VALUE clauses, VALUE location) {
    rbs_ast_directives_use_t *node = malloc(sizeof(rbs_ast_directives_use_t));

    *node = (rbs_ast_directives_use_t) {
        .base = (rbs_node_t) {
    ...
    // that will own them. The fields are unmarked in `rbs_struct_to_ruby_value` where we create the final Ruby object
    // and free the intermediate C struct.
    rb_gc_register_address(&node->clauses);
    rb_gc_register_address(&node->location);
...
rbs_ast_directives_use_single_clause_t *rbs_ast_directives_use_single_clause_new(VALUE type_name, VALUE new_name, VALUE location) {
    rbs_ast_directives_use_single_clause_t *node = malloc(sizeof(rbs_ast_directives_use_single_clause_t));

    *node = (rbs_ast_directives_use_single_clause_t) {
        .base = (rbs_node_t) {
    ...
    // that will own them. The fields are unmarked in `rbs_struct_to_ruby_value` where we create the final Ruby object
    // and free the intermediate C struct.
    rb_gc_register_address(&node->type_name);
    rb_gc_register_address(&node->new_name);
    rb_gc_register_address(&node->location);
...
rbs_ast_directives_use_wildcard_clause_t *rbs_ast_directives_use_wildcard_clause_new(VALUE namespace, VALUE location) {
    rbs_ast_directives_use_wildcard_clause_t *node = malloc(sizeof(rbs_ast_directives_use_wildcard_clause_t));

    *node = (rbs_ast_directives_use_wildcard_clause_t) {
        .base = (rbs_node_t) {
    ...
    // that will own them. The fields are unmarked in `rbs_struct_to_ruby_value` where we create the final Ruby object
    // and free the intermediate C struct.
    rb_gc_register_address(&node->namespace);
    rb_gc_register_address(&node->location);
...
rbs_ast_members_alias_t *rbs_ast_members_alias_new(VALUE new_name, VALUE old_name, VALUE kind, VALUE annotations, VALUE location, VALUE comment) {
    rbs_ast_members_alias_t *node = malloc(sizeof(rbs_ast_members_alias_t));
    ...
    *node = (rbs_ast_members_alias_t) {
    ...
    rb_gc_register_address(&node->new_name);
    rb_gc_register_address(&node->old_name);
    rb_gc_register_address(&node->kind);
    rb_gc_register_address(&node->annotations);
    rb_gc_register_address(&node->location);
    rb_gc_register_address(&node->comment);
...
rbs_ast_members_attr_accessor_t *rbs_ast_members_attr_accessor_new(VALUE name, VALUE type, VALUE ivar_name, VALUE kind, VALUE annotations, VALUE location, VALUE comment, VALUE visibility) {
    rbs_ast_members_attr_accessor_t *node = malloc(sizeof(rbs_ast_members_attr_accessor_t));

    *node = (rbs_ast_members_attr_accessor_t) {
        .base = (rbs_node_t) {
    ...
    rb_gc_register_address(&node->name);
    rb_gc_register_address(&node->type);
    rb_gc_register_address(&node->ivar_name);
    rb_gc_register_address(&node->kind);
    rb_gc_register_address(&node->annotations);
    rb_gc_register_address(&node->location);
    rb_gc_register_address(&node->comment);
    rb_gc_register_address(&node->visibility);
...
rbs_ast_members_attr_reader_t *rbs_ast_members_attr_reader_new(VALUE name, VALUE type, VALUE ivar_name, VALUE kind, VALUE annotations, VALUE location, VALUE comment, VALUE visibility) {
    rbs_ast_members_attr_reader_t *node = malloc(sizeof(rbs_ast_members_attr_reader_t));

    *node = (rbs_ast_members_attr_reader_t) {
        .base = (rbs_node_t) {
...
rbs_ast_members_attr_writer_t *rbs_ast_members_attr_writer_new(VALUE name, VALUE type, VALUE ivar_name, VALUE kind, VALUE annotations, VALUE location, VALUE comment, VALUE visibility) {
    rbs_ast_members_attr_writer_t *node = malloc(sizeof(rbs_ast_members_attr_writer_t));
...
rbs_ast_members_class_instance_variable_t *rbs_ast_members_class_instance_variable_new(VALUE name, VALUE type, VALUE location, VALUE comment) {
    rbs_ast_members_class_instance_variable_t *node = malloc(sizeof(rbs_ast_members_class_instance_variable_t));

    *node = (rbs_ast_members_class_instance_variable_t) {
        .base = (rbs_node_t) {
...
rbs_ast_members_class_variable_t *rbs_ast_members_class_variable_new(VALUE name, VALUE type, VALUE location, VALUE comment) {
    rbs_ast_members_class_variable_t *node = malloc(sizeof(rbs_ast_members_class_variable_t));

    *node = (rbs_ast_members_class_variable_t) {
        .base = (rbs_node_t) {
...
rbs_ast_members_extend_t *rbs_ast_members_extend_new(VALUE name, VALUE args, VALUE annotations, VALUE location, VALUE comment) {
    rbs_ast_members_extend_t *node = malloc(sizeof(rbs_ast_members_extend_t));

    *node = (rbs_ast_members_extend_t) {
        .base = (rbs_node_t) {
...
rbs_ast_members_include_t *rbs_ast_members_include_new(VALUE name, VALUE args, VALUE annotations, VALUE location, VALUE comment) {
    rbs_ast_members_include_t *node = malloc(sizeof(rbs_ast_members_include_t));

    *node = (rbs_ast_members_include_t) {
        .base = (rbs_node_t) {
...
rbs_ast_members_instance_variable_t *rbs_ast_members_instance_variable_new(VALUE name, VALUE type, VALUE location, VALUE comment) {
    rbs_ast_members_instance_variable_t *node = malloc(sizeof(rbs_ast_members_instance_variable_t));

    *node = (rbs_ast_members_instance_variable_t) {
        .base = (rbs_node_t) {
...
rbs_ast_members_method_definition_t *rbs_ast_members_method_definition_new(VALUE name, VALUE kind, VALUE overloads, VALUE annotations, VALUE location, VALUE comment, VALUE overloading, VALUE visibility) {
    rbs_ast_members_method_definition_t *node = malloc(sizeof(rbs_ast_members_method_definition_t));

    *node = (rbs_ast_members_method_definition_t) {
        .base = (rbs_node_t) {
    ...
    rb_gc_register_address(&node->name);
    rb_gc_register_address(&node->kind);
    rb_gc_register_address(&node->overloads);
    rb_gc_register_address(&node->annotations);
    rb_gc_register_address(&node->location);
    rb_gc_register_address(&node->comment);
    rb_gc_register_address(&node->overloading);
    rb_gc_register_address(&node->visibility);
...
rbs_ast_members_method_definition_overload_t *rbs_ast_members_method_definition_overload_new(VALUE annotations, VALUE method_type) {
    rbs_ast_members_method_definition_overload_t *node = malloc(sizeof(rbs_ast_members_method_definition_overload_t));

    *node = (rbs_ast_members_method_definition_overload_t) {
        .base = (rbs_node_t) {
    ...
    // and free the intermediate C struct.
    rb_gc_register_address(&node->annotations);
    rb_gc_register_address(&node->method_type);
...
rbs_ast_members_prepend_t *rbs_ast_members_prepend_new(VALUE name, VALUE args, VALUE annotations, VALUE location, VALUE comment) {
    rbs_ast_members_prepend_t *node = malloc(sizeof(rbs_ast_members_prepend_t));

    *node = (rbs_ast_members_prepend_t) {
        .base = (rbs_node_t) {
...
rbs_ast_members_private_t *rbs_ast_members_private_new(VALUE location) {
    rbs_ast_members_private_t *node = malloc(sizeof(rbs_ast_members_private_t));
...
rbs_ast_members_public_t *rbs_ast_members_public_new(VALUE location) {
    rbs_ast_members_public_t *node = malloc(sizeof(rbs_ast_members_public_t));

    *node = (rbs_ast_members_public_t) {
        .base = (rbs_node_t) {
...
rbs_ast_type_param_t *rbs_ast_type_param_new(VALUE name, VALUE variance, VALUE upper_bound, VALUE default_type, VALUE unchecked, VALUE location) {
    rbs_ast_type_param_t *node = malloc(sizeof(rbs_ast_type_param_t));

    *node = (rbs_ast_type_param_t) {
        .base = (rbs_node_t) {
    ...
    // and free the intermediate C struct.
    rb_gc_register_address(&node->name);
    rb_gc_register_address(&node->variance);
    rb_gc_register_address(&node->upper_bound);
    rb_gc_register_address(&node->default_type);
    rb_gc_register_address(&node->unchecked);
    rb_gc_register_address(&node->location);
...
rbs_method_type_t *rbs_method_type_new(VALUE type_params, VALUE type, VALUE block, VALUE location) {
    rbs_method_type_t *node = malloc(sizeof(rbs_method_type_t));

    *node = (rbs_method_type_t) {
        .base = (rbs_node_t) {
    ...
    rb_gc_register_address(&node->type_params);
    rb_gc_register_address(&node->type);
    rb_gc_register_address(&node->block);
    rb_gc_register_address(&node->location);
...
rbs_namespace_t *rbs_namespace_new(VALUE path, VALUE absolute) {
    rbs_namespace_t *node = malloc(sizeof(rbs_namespace_t));

    *node = (rbs_namespace_t) {
        .base = (rbs_node_t) {
            .type = RBS_NAMESPACE
        },
        .path = path,
    ...
    // that will own them. The fields are unmarked in `rbs_struct_to_ruby_value` where we create the final Ruby object
    // and free the intermediate C struct.
    rb_gc_register_address(&node->path);
    rb_gc_register_address(&node->absolute);

    return node;
}

rbs_type_name_t *rbs_type_name_new(VALUE namespace, VALUE name) {
    rbs_type_name_t *node = malloc(sizeof(rbs_type_name_t));

    *node = (rbs_type_name_t) {
        .base = (rbs_node_t) {
            .type = RBS_TYPE_NAME
        },
        .namespace = namespace,
...
rbs_types_alias_t *rbs_types_alias_new(VALUE name, VALUE args, VALUE location) {
    rbs_types_alias_t *node = malloc(sizeof(rbs_types_alias_t));

    *node = (rbs_types_alias_t) {
        .base = (rbs_node_t) {
...
rbs_types_bases_any_t *rbs_types_bases_any_new(VALUE todo, VALUE location) {
    rbs_types_bases_any_t *node = malloc(sizeof(rbs_types_bases_any_t));

    *node = (rbs_types_bases_any_t) {
        .base = (rbs_node_t) {
    ...
    // that will own them. The fields are unmarked in `rbs_struct_to_ruby_value` where we create the final Ruby object
    // and free the intermediate C struct.
    rb_gc_register_address(&node->todo);
    rb_gc_register_address(&node->location);
...
rbs_types_bases_bool_t *rbs_types_bases_bool_new(VALUE location) {
    rbs_types_bases_bool_t *node = malloc(sizeof(rbs_types_bases_bool_t));
...
rbs_types_bases_bottom_t *rbs_types_bases_bottom_new(VALUE location) {
    rbs_types_bases_bottom_t *node = malloc(sizeof(rbs_types_bases_bottom_t));

    *node = (rbs_types_bases_bottom_t) {
        .base = (rbs_node_t) {
...
rbs_types_bases_class_t *rbs_types_bases_class_new(VALUE location) {
    rbs_types_bases_class_t *node = malloc(sizeof(rbs_types_bases_class_t));

    *node = (rbs_types_bases_class_t) {
        .base = (rbs_node_t) {
...
rbs_types_bases_instance_t *rbs_types_bases_instance_new(VALUE location) {
    rbs_types_bases_instance_t *node = malloc(sizeof(rbs_types_bases_instance_t));

    *node = (rbs_types_bases_instance_t) {
        .base = (rbs_node_t) {
...
rbs_types_bases_nil_t *rbs_types_bases_nil_new(VALUE location) {
    rbs_types_bases_nil_t *node = malloc(sizeof(rbs_types_bases_nil_t));

    *node = (rbs_types_bases_nil_t) {
        .base = (rbs_node_t) {
...
rbs_types_bases_self_t *rbs_types_bases_self_new(VALUE location) {
    rbs_types_bases_self_t *node = malloc(sizeof(rbs_types_bases_self_t));

    *node = (rbs_types_bases_self_t) {
        .base = (rbs_node_t) {
...
rbs_types_bases_top_t *rbs_types_bases_top_new(VALUE location) {
    rbs_types_bases_top_t *node = malloc(sizeof(rbs_types_bases_top_t));

    *node = (rbs_types_bases_top_t) {
        .base = (rbs_node_t) {
...
rbs_types_bases_void_t *rbs_types_bases_void_new(VALUE location) {
    rbs_types_bases_void_t *node = malloc(sizeof(rbs_types_bases_void_t));

    *node = (rbs_types_bases_void_t) {
        .base = (rbs_node_t) {
...
rbs_types_block_t *rbs_types_block_new(VALUE type, VALUE required, VALUE self_type) {
    rbs_types_block_t *node = malloc(sizeof(rbs_types_block_t));

    *node = (rbs_types_block_t) {
        .base = (rbs_node_t) {
    ...
    // and free the intermediate C struct.
    rb_gc_register_address(&node->type);
    rb_gc_register_address(&node->required);
    rb_gc_register_address(&node->self_type);

    return node;
}

rbs_types_class_instance_t *rbs_types_class_instance_new(VALUE name, VALUE args, VALUE location) {
    rbs_types_class_instance_t *node = malloc(sizeof(rbs_types_class_instance_t));

    *node = (rbs_types_class_instance_t) {
        .base = (rbs_node_t) {
...
rbs_types_class_singleton_t *rbs_types_class_singleton_new(VALUE name, VALUE location) {
    rbs_types_class_singleton_t *node = malloc(sizeof(rbs_types_class_singleton_t));
...
rbs_types_function_t *rbs_types_function_new(VALUE required_positionals, VALUE optional_positionals, VALUE rest_positionals, VALUE trailing_positionals, VALUE required_keywords, VALUE optional_keywords, VALUE rest_keywords, VALUE return_type) {
    rbs_types_function_t *node = malloc(sizeof(rbs_types_function_t));
    ...
    *node = (rbs_types_function_t) {
    ...
    // that will own them. The fields are unmarked in `rbs_struct_to_ruby_value` where we create the final Ruby object
    // and free the intermediate C struct.
    rb_gc_register_address(&node->required_positionals);
    rb_gc_register_address(&node->optional_positionals);
    rb_gc_register_address(&node->rest_positionals);
    rb_gc_register_address(&node->trailing_positionals);
    rb_gc_register_address(&node->required_keywords);
    rb_gc_register_address(&node->optional_keywords);
    rb_gc_register_address(&node->rest_keywords);
    rb_gc_register_address(&node->return_type);

    return node;
}

rbs_types_function_param_t *rbs_types_function_param_new(VALUE type, VALUE name, VALUE location) {
    rbs_types_function_param_t *node = malloc(sizeof(rbs_types_function_param_t));

    *node = (rbs_types_function_param_t) {
        .base = (rbs_node_t) {
...
rbs_types_interface_t *rbs_types_interface_new(VALUE name, VALUE args, VALUE location) {
    rbs_types_interface_t *node = malloc(sizeof(rbs_types_interface_t));

    *node = (rbs_types_interface_t) {
        .base = (rbs_node_t) {
...
rbs_types_intersection_t *rbs_types_intersection_new(VALUE types, VALUE location) {
    rbs_types_intersection_t *node = malloc(sizeof(rbs_types_intersection_t));

    *node = (rbs_types_intersection_t) {
        .base = (rbs_node_t) {
    ...
    // that will own them. The fields are unmarked in `rbs_struct_to_ruby_value` where we create the final Ruby object
    // and free the intermediate C struct.
    rb_gc_register_address(&node->types);
    rb_gc_register_address(&node->location);
...
rbs_types_literal_t *rbs_types_literal_new(VALUE literal, VALUE location) {
    rbs_types_literal_t *node = malloc(sizeof(rbs_types_literal_t));

    *node = (rbs_types_literal_t) {
        .base = (rbs_node_t) {
    ...
    // that will own them. The fields are unmarked in `rbs_struct_to_ruby_value` where we create the final Ruby object
    // and free the intermediate C struct.
    rb_gc_register_address(&node->literal);
    rb_gc_register_address(&node->location);
...
rbs_types_optional_t *rbs_types_optional_new(VALUE type, VALUE location) {
    rbs_types_optional_t *node = malloc(sizeof(rbs_types_optional_t));

    *node = (rbs_types_optional_t) {
        .base = (rbs_node_t) {
...
rbs_types_proc_t *rbs_types_proc_new(VALUE type, VALUE block, VALUE location, VALUE self_type) {
    rbs_types_proc_t *node = malloc(sizeof(rbs_types_proc_t));

    *node = (rbs_types_proc_t) {
        .base = (rbs_node_t) {
            .type = RBS_TYPES_PROC
        },
        .type = type,
...
rbs_types_record_t *rbs_types_record_new(VALUE all_fields, VALUE location) {
    rbs_types_record_t *node = malloc(sizeof(rbs_types_record_t));

    *node = (rbs_types_record_t) {
        .base = (rbs_node_t) {
    ...
    // that will own them. The fields are unmarked in `rbs_struct_to_ruby_value` where we create the final Ruby object
    // and free the intermediate C struct.
    rb_gc_register_address(&node->all_fields);
    rb_gc_register_address(&node->location);
...
rbs_types_tuple_t *rbs_types_tuple_new(VALUE types, VALUE location) {
    rbs_types_tuple_t *node = malloc(sizeof(rbs_types_tuple_t));

    *node = (rbs_types_tuple_t) {
        .base = (rbs_node_t) {
...
rbs_types_union_t *rbs_types_union_new(VALUE types, VALUE location) {
    rbs_types_union_t *node = malloc(sizeof(rbs_types_union_t));

    *node = (rbs_types_union_t) {
        .base = (rbs_node_t) {
...
rbs_types_untyped_function_t *rbs_types_untyped_function_new(VALUE return_type) {
    rbs_types_untyped_function_t *node = malloc(sizeof(rbs_types_untyped_function_t));

    *node = (rbs_types_untyped_function_t) {
        .base = (rbs_node_t) {
...
rbs_types_variable_t *rbs_types_variable_new(VALUE name, VALUE location) {
    rbs_types_variable_t *node = malloc(sizeof(rbs_types_variable_t));

    *node = (rbs_types_variable_t) {
        .base = (rbs_node_t) {
